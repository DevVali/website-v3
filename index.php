...
$name = "Vali";
$username = "ejvali";
$desc = "I'm ejvali, photographer with the dream to share travel photography and adventures with the world.";
$section = "Home";
$prns = "they/it";
...
<body><div id="pageselect">
  ...
  <!-- Bio -->
  <p id="bio">I'm ejvali, photographer with the dream to share travel photography and adventures with the world.<br>I've been growing up in online world and always wanted to explore more about computers.<br>That's the reason I started learning to code. In the early 2022,<br>I wrote my very first project with the use of HTML and CSS. Now, I'm exploring the languages PHP and Python.<br><br>I'm Instagram content creator and I manage over 5 social media accounts.<br><a href="https://www.instagram.com/<?php echo $username ?>">Explore my photography now.</a></p>
